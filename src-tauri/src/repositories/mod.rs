...
pub trait MasterRepository: Send + Sync {
    ...
    fn find_customer(&self, conn: &Connection, code: &str)
    ...
    fn find_supplier(&self, conn: &Connection, code: &str)
    ...
    fn list_items(&self, conn: &Connection, status: Option<&str>)
...
pub trait InvoiceRepository: Send + Sync {
    ...
    fn find_invoice(&self, conn: &Connection, number: &str)
